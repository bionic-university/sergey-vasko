 ...
 */
class Affiliate extends \BionicUniversity\SergeyVasko\JobmagazineBundle\Entity\Affiliate implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'BionicUniversity\\SergeyVasko\\JobmagazineBundle\\Entity\\Affiliate' . "\0" . 'id', '' . "\0" . 'BionicUniversity\\SergeyVasko\\JobmagazineBundle\\Entity\\Affiliate' . "\0" . 'url', '' . "\0" . 'BionicUniversity\\SergeyVasko\\JobmagazineBundle\\Entity\\Affiliate' . "\0" . 'email', '' . "\0" . 'BionicUniversity\\SergeyVasko\\JobmagazineBundle\\Entity\\Affiliate' . "\0" . 'token', '' . "\0" . 'BionicUniversity\\SergeyVasko\\JobmagazineBundle\\Entity\\Affiliate' . "\0" . 'is_active', '' . "\0" . 'BionicUniversity\\SergeyVasko\\JobmagazineBundle\\Entity\\Affiliate' . "\0" . 'created_at', '' . "\0" . 'BionicUniversity\\SergeyVasko\\JobmagazineBundle\\Entity\\Affiliate' . "\0" . 'categories');
        }
