 ...
 */
class Category extends \BionicUniversity\SergeyVasko\JobmagazineBundle\Entity\Category implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'BionicUniversity\\SergeyVasko\\JobmagazineBundle\\Entity\\Category' . "\0" . 'id', '' . "\0" . 'BionicUniversity\\SergeyVasko\\JobmagazineBundle\\Entity\\Category' . "\0" . 'name', '' . "\0" . 'BionicUniversity\\SergeyVasko\\JobmagazineBundle\\Entity\\Category' . "\0" . 'jobs', '' . "\0" . 'BionicUniversity\\SergeyVasko\\JobmagazineBundle\\Entity\\Category' . "\0" . 'affiliates', '' . "\0" . 'BionicUniversity\\SergeyVasko\\JobmagazineBundle\\Entity\\Category' . "\0" . 'active_jobs', '' . "\0" . 'BionicUniversity\\SergeyVasko\\JobmagazineBundle\\Entity\\Category' . "\0" . 'more_jobs', '' . "\0" . 'BionicUniversity\\SergeyVasko\\JobmagazineBundle\\Entity\\Category' . "\0" . 'slug');
        }
